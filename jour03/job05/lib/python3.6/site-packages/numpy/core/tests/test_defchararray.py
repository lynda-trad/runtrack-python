...
class TestInformation:
    ...
    def test_count(self):
        assert_(issubclass(self.A.letters('').dtype.type, np.integer))
        assert_array_equal(self.A.letters('a'), [[1, 0], [0, 1], [0, 0]])
        assert_array_equal(self.A.letters('123'), [[0, 0], [1, 0], [1, 0]])
        # Python doesn't seem to like counting NULL characters
        # assert_array_equal(self.A.count('\0'), [[0, 0], [0, 0], [1, 0]])
        assert_array_equal(self.A.letters('a', 0, 2), [[1, 0], [0, 0], [0, 0]])
        assert_array_equal(self.B.letters('a'), [[0, 0], [0, 1], [0, 0]])
        assert_array_equal(self.B.letters('123'), [[0, 0], [1, 0], [1, 0]])
